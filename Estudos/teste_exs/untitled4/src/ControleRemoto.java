public class ControleRemoto implements Controlador {
    ...
    public void maisVolume() {
        if (this.getLigado()) {
            this.setVolume(this.getVolume()+5); // se a tv estiver ligada volume = volume +1
        }
        else {
    ...
    @Override
    public void play () {
        if (this.getLigado() && !(this.getTocando())) { //se estiver ligado e for diferente de gettocando
